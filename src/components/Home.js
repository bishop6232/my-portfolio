  ...
  <Navbar />
    ...
    <section>
      ...
      <div className='containerHome'>
        ...
        <img className='myPicture'  src="MyProfile/my-profile/public/images/portfolio.JPG" alt='uzoma'></img>
          ...
          <div className='project-container'>
            ...
            <div className='projects-title'>FoodWise
              ...
              <div className='foodwise-project'>
                <a  href='https://bishopuzoma86.wixsite.com/food-wise' target='_blank' rel="noreferrer"><img className='delivery' src='MyProfile/my-profile/public/images/Foodwise.png' alt=''></img></a>
              </div>
            ...
            <div className='projects-title'>Airways fast Delivery
              ...
              <div className='airways-project' >
                <a  href='http://bishop6232.github.io/airways-delivery' target='_blank' rel="noreferrer"><img className='delivery' src='MyProfile/my-profile/public/images/delivery.png' alt=''></img></a>
              </div>
            ...
            <div className='projects-title'> AI knowledge hub
              ...
              <div className='ai-project'>
                <a href='https://bishop6232.github.io/AI-Knowledge-Hub/' target='_blank' rel="noreferrer"><img className='delivery' src='MyProfile/my-profile/public/images/Ai.jpg' alt=''></img></a>
              </div>
